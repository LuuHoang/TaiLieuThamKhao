<?php
/**
 * @api {post} /app/albums Create album
 * @apiVersion 0.1.0
 * @apiName CreateAlbum
 * @apiGroup Albums For App
 *
 * @apiUse HeaderToken
 *
...
/**
 * @api {put} /app/albums/:albumId Update album
 * @apiVersion 0.1.0
 * @apiName UpdateAlbum
 * @apiGroup Albums For App
 *
...
/**
 * @api {get} /app/albums Get List Album
 * @apiVersion 0.1.0
 ...
 * @apiSuccess data_list.user_id user id
...
/**
 * @api {get} /app/albums/:albumId Get Album Detail
 * @apiVersion 0.1.0
...
/**
 * @api {post} /app/albums/:albumId/avatar update avatar album
 * @apiVersion 0.1.0
...
/**
 * @api {post} /app/albums/:albumId/share Share album for Email
 * @apiVersion 0.1.0
...
/**
 * @api {get} /app/share/targets Get List Name, Email Shared Album
 * @apiVersion 0.1.0
