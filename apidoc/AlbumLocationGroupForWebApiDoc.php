...
/**
 * @api {post} /web/albums/:albumId/locations Create Album Locations
 * @apiVersion 0.1.0
 * @apiName CreateAlbumLocations
 * @apiGroup Album Location For Web
 *
 * @apiUse HeaderToken
 *
...
/**
 * @api {put} /web/albums/:albumId/locations/:locationId Update Album Location
 * @apiVersion 0.1.0
...
/**
 * @api {delete} /web/albums/:albumId/locations/:albumLocationId Delete Album Location
 * @apiVersion 0.1.0
