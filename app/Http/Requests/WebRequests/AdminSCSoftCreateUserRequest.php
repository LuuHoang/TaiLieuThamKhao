...
class AdminSCSoftCreateUserRequest extends BaseRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            "staff_code"    => "nullable|string|max:8|unique:users,staff_code,NULL,id,deleted_at,NULL,company_id,{$this->company_id}",
            "full_name"     => "required|string|max:255",
            "email"         => "required|email|max:255|unique:users,email,NULL,id,deleted_at,NULL,company_id,{$this->company_id}",
            "address"       => "nullable|string|max:255",
            "password"      => "required|string|min:6|max:255",
            "department"    => "nullable|string|max:255",
            "position"      => "nullable|string|max:255",
            "role_id"       => "required|integer|exists:user_roles,id,company_id,{$this->company_id},deleted_at,NULL",
    ...
    {
        return [
            'company_id.required'  => 'messages.company_id_is_required',
            'company_id.exists'  => 'messages.company_id_does_not_exist',
            ...
            'role_id.in'  => 'messages.user_role_is_incorrect',
