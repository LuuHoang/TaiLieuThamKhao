...
class AlbumLocationForShareUserResource extends JsonResource
{
...
//                if ($commonService->checkSettingCommentPublic($comment->user) || $this->album->user_id === $comment->creator_id) {
...
//        }
        return [
            ...
            "medias"            =>  AlbumLocationMediaForShareUserResource::collection($this->albumLocationMedias),
