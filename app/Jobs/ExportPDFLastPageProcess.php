...
class ExportPDFLastPageProcess implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $exportService->exportPDFLastPage($this->_format, $this->_data, $this->_userId, $this->_albumId, $this->_fileName, $this->_totalPage, $this->_createTime);
    }
