...
class ExportPDFProcess implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $exportService->exportAlbumPDFByPage($this->_format, $this->_data, $this->_userId, $this->_albumId, $this->_fileName, $this->_totalPage, $this->_createTime);
    }
